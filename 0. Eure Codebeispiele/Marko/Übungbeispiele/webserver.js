...
//   const password = "codersbay123";
//   if (username === req.body.Username && password === req.body.Password) {
//     next();
//   } else {
//     res.status(401).send("Your User data are incorrect, try again");
//   }
// }
app.get("/iss", (req, res) => {
...
app.post("/postjoke", (req, res) => {
  ...
  res.status(201).send("Joke added");
  jokes.push(newJoke);
});
//5. PUT a joke
...
app.delete("/jokes/:id", (req, res) => {
  const idJoke = parseInt(req.params.id);
  const deleteJoke = jokes.find((joke) => joke.id !== idJoke);
  jokes = deleteJoke;
